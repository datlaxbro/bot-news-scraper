...
class WebsiteScraper:
    ...
    async def scrape(self):
        ...
        Returns:
            list: A list of formatted information extracted from the website.
        """
        try:
...
async def main():
    """
    The main function that orchestrates the scraping and sending of information to Discord.
    """
    # Read existing titles from the log file
    existing_titles = LogFileHandler.read_log_file()
